...
function _simple1(d3,simple_data,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 2000
    ;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("simple1")).define("simple1", ["d3","simple_data","drag","url_list","invalidation"], _simple1);
  return main;
}
